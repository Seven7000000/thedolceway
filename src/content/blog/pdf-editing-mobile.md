---
title: "PDF Editing on Your Phone: What Actually Works"
description: "Signing, merging, annotating PDFs on mobile used to be terrible. It's gotten better. Here's what actually works in 2025."
date: 2025-02-14
tags: ["utility", "productivity", "comparison"]
draft: false
image: "/blog-images/mobile-pdf-comparison.png"
---
...
B) Print, sign, scan (in 2025?)
C) Use an app that actually works
...
1. **Sign documents** — Add your signature without printing
2. **Fill forms** — Put text in form fields
3. **Merge PDFs** — Combine multiple documents
4. **Annotate** — Highlight, underline, add comments
...
I built [PDFast](/apps/pdfast) because every option was either too expensive, too slow, or too annoying.
